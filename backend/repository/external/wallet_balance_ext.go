...
func (wbDeps *WalletBalanceExt) GetWalletBalance(ctx context.Context, address string) (*m.Response, *errs.ErrorResponse) {
	url := "https://api.etherscan.io/api?module=account&action=balance&address=" + address + "&tag=latest&apikey=" + wbDeps.opts.Config.Etherscan.Token
